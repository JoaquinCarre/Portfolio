    ...
    return (
      <div className="projects-block span-2" style={{ backgroundColor }}>
        <div className="block-content projects-content">
          <ProjectCard image="./src/assets/img-jovenaccion.png" title="Jóvenes en Acción" description={<>Web creada bajo el programa <strong>Proyecto Real</strong> de <strong style={{color:"black"}}>CoderHouse</strong>, beneficio obtenido por estar en el TOP 10% de alumnos en el curso de JavaScript.</>} linkWeb="https://jovenaccion.com" />
          <ProjectCard image="./src/assets/img-simonsays.png" title="Simón Dice" description={<><strong>Simón Dice</strong> es un juego donde se crea una serie de sonidos y luces que el jugador debe repetir.</>} linkWeb="https://joaquincarre.github.io/Simon-Says/" linkGH="https://github.com/JoaquinCarre/Simon-Says" />
          <ProjectCard image="./src/assets/img-equinoccioludico.png" title="Equinoccio Lúdico I" description={<>Proyecto realizado en el curso de <strong>ReactJS</strong> de <strong style={{color:"black"}}>CoderHouse</strong></>} linkWeb="https://joaquincarre.github.io/equinoccio-ludico-carre/" linkGH="https://github.com/JoaquinCarre/equinoccio-ludico-carre" />
          <ProjectCard image="./src/assets/img-equinoccioludico-backend.png" title="Equinoccio Lúdico II" description={<>Proyecto realizado en el curso de <strong>BackEnd</strong> de <strong style={{color:"black"}}>CoderHouse</strong></>} linkWeb="https://proyecto-final-backend-coderhouse-1786-dev.fl0.io/" linkGH="https://github.com/JoaquinCarre/proyecto-final-backend-coderhouse" />
        </div>
      </div>
    );
  }
