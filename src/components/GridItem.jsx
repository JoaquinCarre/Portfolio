...
const GridItem = ({ section, backgroundColor, texts, textsBold, icon, personalImage, me, career}) => {
  ...
  const handleMouseEnter = () => {
    setShowMe(me);
    setShowTexts(!me && !career);
    setShowCertificates(career);
  };
        ...
        <div className="grid-block image-me" style={{ backgroundColor }}>
          ...
          <div className='other-contacts'>
            <div className='alternative-contact'>
              ...
              <h4 className='text-alternative-contact'>/JoaquinCarre</h4>
            </div>
            <div className='alternative-contact'>
              <a href="https://www.linkedin.com/in/joaquin-carre">
                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px">
              ...
              <h4 className='text-alternative-contact'>/joaquin-carre</h4>
            </div>
            <div className='alternative-contact'>
    ...
    return (
      <div className="projects-block span-2" style={{ backgroundColor }}>
        <div className="block-content projects-content">
          <ProjectCard image={jovenaccion} title="Jóvenes en Acción" description={ language === 'es' ? <>Web creada bajo el programa <strong>Proyecto Real</strong> de <strong style={{color:"white"}}>CoderHouse</strong>, beneficio obtenido por estar en el TOP 10% de alumnos en el curso de <strong>JavaScript</strong>.</> : <>Website created under the <strong>"Proyecto Real"</strong> program by <strong style={{color:"black"}}>CoderHouse</strong>, a benefit obtained for being in the top 10% of students in the JavaScript course.</>} linkWeb="https://web.archive.org/web/20240528165033/https://www.jovenaccion.com/" />
          <ProjectCard image={simonsays} title={ language === 'es' ? "Simón Dice" : "Simon Says"} description={ language === 'es' ? <><strong>Simón Dice</strong> es un juego donde se crea una secuencia de sonidos y luces que el jugador debe repetir.</> : <> <strong>Simon Says</strong> is a game where a series of sounds and lights are created, which the player must repeat. </>} linkWeb="https://joaquincarre.github.io/Simon-Says/" linkGH="https://github.com/JoaquinCarre/Simon-Says" />
          <ProjectCard image={equiludi} title="Equinoccio Lúdico I" description={ language === 'es' ? <>Proyecto realizado en el curso de <strong>ReactJS</strong> de <strong style={{color:"white"}}>CoderHouse</strong></> : <>Project made in the <strong>ReactJS</strong> course at <strong style={{color:"antiquewhite"}}>CoderHouse</strong></>} linkWeb="https://joaquincarre.github.io/equinoccio-ludico-carre/" linkGH="https://github.com/JoaquinCarre/equinoccio-ludico-carre" />
          <ProjectCard image={equiludi2} title="Equinoccio Lúdico II" description={ language === 'es' ? <>Proyecto realizado en el curso de <strong>BackEnd</strong> de <strong style={{color:"white"}}>CoderHouse</strong></> : <>Project made in the <strong>BackEnd</strong> course at <strong style={{color:"black"}}>CoderHouse</strong></>} /* linkWeb="https://proyecto-final-backend-coderhouse-1786-dev.fl0.io/"  */linkGH="https://github.com/JoaquinCarre/proyecto-final-backend-coderhouse" />
        </div>
      </div>
    );
  }
